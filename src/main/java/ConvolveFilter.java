...
public class ConvolveFilter extends AbstractBufferedImageOp {
	...
	public static void convolveV(Kernel kernel, int[] inPixels, int[] outPixels, int width, int height, boolean alpha, int edgeAction) {
        ...
        /*
        http://grepcode.com/file/repo1.maven.org/maven2/com.jhlabs/filters/2.0.235/com/jhlabs/image/PixelUtils.java
        This method had to be created separately due to PixlUtils.clamp not wanting to work correctly.
        */
